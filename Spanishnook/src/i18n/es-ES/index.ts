...
export default {
  ...
  indexDetrasDeSpanishnook: '​En SpanishNook creemos que aprender un idioma debe ser una experiencia cercana, flexible y positiva. Por eso hemos creado este rincón online: un espacio pensado para acompañarte en tu camino con clases en vivo y personalizadas. <br><br>El proyecto nace de la experiencia y la pasión de Paula, profesora de español con varios años de trayectoria en la enseñanza. <br><br><strong>SpanishNook es ese lugar donde sentirte cómodo aprendiendo.</strong>',
