...
export default {
  ...
  test:{
        ...
        alCompletar:'Al finalizar, recibirás una orientación aproximada de tu nivel de español. <strong>Este test no sustituye una evaluación oficial, pero te ayudará a encontrar el curso que mejor se adapta a ti.</strong>',
  ...
  NuestrasClases: {
    ...
    IntroIndividuales: '<strong>Aprende a tu ritmo con clases pensadas solo para ti y tus necesidades de aprendizaje.</strong> <br><br> Elige si quieres mejorar tu fluidez al hablar o avanzar en otros aspectos generales de la lengua. Tú eliges el ritmo, los temas y los objetivos. Nosotros ponemos el acompañamiento y los recursos.',
    ...
    ListaComoFuncionanInd5: '<strong>Cancelaciones hasta con 24 h de antelación. La clase se agendará para otro día sin coste adicional</strong>',
  ...
  SobreSpanish:{
    ...
    cercania: '<strong>Cercanía</strong>: trato humano, clases reducidas y ambiente relajado.',
