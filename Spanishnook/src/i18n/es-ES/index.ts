...
export default {
  ...
  indexDanosTuOpinion: 'Danos tu opinión',
  ...
  test:{
        ...
        evaluaTuNivel: '🏆 Evalúa tu conocimiento de español', 
        ...
        alCompletar:'Al finalizar recibirás una orientación aproximada de tu nivel de español. <strong>Este test no sustituye a una evaluación oficial, pero te ayudará a encontrar el curso que mejor se adapta a ti.</strong>',
  ...
  NuestrasClases: {
    ...
    textoNuestrasClases: 'En SpanishNook no hay un único camino: cada estudiante tiene sus metas, su tiempo y su forma de aprender. <br> Por eso, te ofrecemos opciones flexibles para que elijas la que mejor encaje contigo: clases privadas o cursos en grupos reducidos.',
    ...
    TextoNuestrosCursosGrupo: 'Cada semana nos reunimos en grupos reducidos para practicar español de forma real, divertida y práctica. Trabajamos con temas actuales y actividades diseñadas para ayudarte a hablar más, soltarte y sentirte cómodo desde el primer día. Aquí hablamos mucho, nos equivocamos sin miedo, reímos, aprendemos vocabulario útil y mejoramos paso a paso.', 
    TextoNuestrosCursosGrupo1: '¿Cómo funcionan las clases grupales?',
    ListaComoFuncionanGrupos1: '<strong>1 clase a la semana </strong> ➡️ 90 minutos',
    ListaComoFuncionanGrupos2: '<strong>Grupos reducidos para que todos participéis de verdad</strong> ➡️ Máximo 6 personas',
    ListaComoFuncionanGrupos3: '<strong>Suscripción mensual (65 €)</strong> ➡️ Sencilla y sin compromiso. Cancela cuando quieras',
    ListaComoFuncionanGrupos4: '<strong>Enfoque comunicativo</strong> ➡️ Clases en vivo, dinámicas y prácticas',
    ListaComoFuncionanGrupos5: '<strong>Grupos por nivel</strong>',
    LogrosGrupales: '⭐ ¿Qué vas a lograr?',
    Logro1Grupales: 'Hablar con más confianza y fluidez</br>',
    ...
    IntroIndividuales: '<strong>Aprende a tu ritmo con clases pensadas solo para ti y a tus necesidades de aprendizaje.</strong> <br><br> Elige si quieres mejorar tu fluidez al hablar o avanzar en otros los aspectos generales de la lengua. Tú eliges el ritmo, los temas y los objetivos. Nosotros ponemos el acompañamiento y los recursos.',
    Modalidades: 'Modalidades',
    Modalidad1: 'Clases de conversación 1:1',
    ...
    Modalidad2: 'Clases generales 1:1',
    TextoModalidad2: 'Nuestras clases generales cubren gramática, vocabulario, comprensión y expresión oral y escrita. Avanza de forma integral en tu dominio del español y sube de nivel.',
    TextoComoFuncionanIndividuales: 'Cómo funcionan las clases individuales:',
    ListaComoFuncionanInd1: '<strong>Sesiones online en vivo de 55 min.🕒</strong> Materiales 100% personalizados',
    ListaComoFuncionanInd2: '<strong>Flexibilidad total 🗓️</strong> Reserva tus clases cuando quieras',
    ListaComoFuncionanInd3: '<strong>Elige la modalidad 🎯</strong> Conversación o General',
    ListaComoFuncionanInd4: '<strong>Feedback y seguimiento continuo 📈</strong> Repositorio compartido (Google Classroom y Google Drive)',
    ListaComoFuncionanInd5: '<strong>Cancelaciones hasta con 24h de antelación. La clase se agendará para otro día sin coste adicional</strong>',
    ...
    esUnPrograma: 'Es un programa mensual por suscripción mensual, sencillo: pagas mes a mes y puedes darte de baja cuando quieras. Así puedes avanzar con regularidad sin complicaciones.',
  ...
  personal: {
    ...
    misReservasConfirmadas: 'Mis reservas confirmadas',
    noTienesReservas: 'No tienes reservas confirmadas.',
    noSePuedeCancelar: 'No se puede cancelar (menos de 72 horas)',
  ...
  SobreSpanish:{
    ...
    intro: '<strong>Detrás de cada clase hay una persona, una historia y una forma de enseñar pensada para ti. En un mundo frenético, aprender también puede ser un refugio.</strong>',
    tulug: 'Tu lugar',
    ...
    loque: 'En Spanish Nook encontrarás...',
    cercania: '<strong>Cercanía</strong>: trato humano, clases reducidas, ambiente relajado.',
    flexibilidad: '<strong>Flexibilidad</strong>: el español se adapta a tu ritmo de vida.',
    confianza: '<strong>Confianza</strong>: acompañamiento real en cada paso de tu aprendizaje.',
    ojalá: '✦ Ojalá este rincón también pueda ser el tuyo.',
    espero: '<strong>Te espero en SpanishNook para dar juntos el siguiente paso.</strong>',
