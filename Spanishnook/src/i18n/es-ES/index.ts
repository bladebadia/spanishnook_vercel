...
export default {
  ...
  NuestrasClases: {
    ...
    IntroNuestrosCursosGrupo: '¿Te pasa que entiendes español pero te cuesta hablar con naturalidad? ¿Quieres ganar confianza al hablar español sin miedo a equivocarte? Este curso es para ti.',
    ...
    ListaComoFuncionanGrupos1: '<strong>1 clase a la semana ➡️ 90 minutos</strong>',
    ListaComoFuncionanGrupos2: '<strong>Grupos reducidos para que todos participéis de verdad ➡️ Máximo 6 personas</strong>',
    ListaComoFuncionanGrupos3: '<strong>Suscripción mensual (65 €)</strong>: sencilla, sin compromiso. Cancela cuando quieras',
    ListaComoFuncionanGrupos4: '<strong>Enfoque comunicativo ➡️ Clases en vivo, dinámicas y prácticas</strong>',
    ...
    IntroIndividuales: 'Aprende a tu ritmo con clases pensadas solo para ti y a tus necesidades de aprendizaje. Elige si quieres mejorar tu fluidez al hablar o avanzar en otros los aspectos generales de la lengua. Tú eliges el ritmo, los temas y los objetivos. Nosotros ponemos el acompañamiento y los recursos.',
    ...
    TextoModalidad2: 'Nuestras clases generales cubren gramática, vocabulario, comprensión y expresión oral y escrita y siempre adaptándonos a tus objetivos específicos de aprendizaje. Avanza de forma integral en tu dominio del español y sube de nivel.',
    TextoComoFuncionanIndividuales: 'Cómo funcionan las clases individuales:',
    ListaComoFuncionanInd1: 'Sesiones online en vivo de 60 minutos 🕒 con materiales 100% personalizados',
    ListaComoFuncionanInd2: 'Flexibilidad total 🗓️: reserva tus clases en el calendario cuando quieras.',
    ListaComoFuncionanInd3: 'Elige tu enfoque: conversación o español general 🎯',
    ListaComoFuncionanInd4: 'Feedback y seguimiento continuo 📈 y repositorio compartido (Google Classroom y Google Drive)',
    ListaComoFuncionanInd5: 'Cancelaciones: puedes cancelar hasta con 24h de antelación. La clase se agendará para otro día sin coste adicional.',
