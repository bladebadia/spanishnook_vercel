...
export default {
  ...
  NuestrasClases: {
    ...
    ListaComoFuncionanGrupos1: '1 clase a la semana ➡️ 90 minutos',
    ListaComoFuncionanGrupos2: 'Grupos reducidos para que todos participéis de verdad ➡️ Máximo 6 personas',
    ListaComoFuncionanGrupos3: 'Suscripción mensual (65 €): sencilla, sin compromiso. Cancela cuando quieras',
    ListaComoFuncionanGrupos4: 'Enfoque comunicativo ➡️ Clases en vivo, dinámicas y prácticas',
    ListaComoFuncionanGrupos5: 'Grupos por nivel',
    LogrosGrupales: '⭐ ¿Qué vas a lograr?',
    Logro1Grupales: 'Mejorar tu fluidez y confianza al hablar español',
    Logro2Grupales: 'Ampliar tu vocabulario y expresiones útiles para el día a día',
    Logro3Grupales: 'Desarrollar habilidades de comprensión e interacción en contextos reales',
    ...
    ListaComoFuncionanIndiv3: 'Elige tu enfoque: conversación o español general 🎯',
