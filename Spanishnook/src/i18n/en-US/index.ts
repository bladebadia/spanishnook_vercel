...
export default {
  ...
  test:{
        ...
        alCompletar: 'At the end, you will receive an approximate orientation of your Spanish level. <strong>This test does not replace an official evaluation, but it will help you choose the course that best fits you.</strong>',
  ...
  NuestrasClases: {
    ...
    textoNuestrasClases: 'At SpanishNook there isn\'t just one path: every student has their own goals, time, and learning style. <br> That\'s why we offer flexible options so you can choose what fits you best: private lessons or small group courses',
    botonClasesIndividuales: 'PRIVATE LESSONS',
    botonClasesConversacion: 'CONVERSATIONAL CLASSES',
    ...
    ClasesConversacion: 'Conversational Group Classes',
    ...
    ListaComoFuncionanGrupos1: '<strong>1 class per week</strong> ➡️ 90 minutes',
    ListaComoFuncionanGrupos2: '<strong>Small groups so everyone can truly participate</strong> ➡️ Maximum 6 people',
    ListaComoFuncionanGrupos3: '<strong>Monthly subscription (€65)</strong> ➡️ Simple and commitment-free. Cancel anytime',
    ListaComoFuncionanGrupos4: '<strong>Communicative Approach</strong> ➡️ Live, dynamic and practical lessons',
    ListaComoFuncionanGrupos5: '<strong>Level-based groups</strong>',
    ...
    Modalidades: 'Lesson Formats',
    Modalidad1: '1:1 Conversational lessons',
    ...
    Modalidad2: '1:1 General Spanish lessons',
    ...
    ListaComoFuncionanInd1: '<strong>Live 55-minute online sessions 🕒</strong> With 100% personalized materials',
    ListaComoFuncionanInd2: '<strong>Total flexibility 🗓️</strong> Book your classes whenever you want',
    ListaComoFuncionanInd3: '<strong>Choose your focus 🎯</strong> Conversation or General Spanish',
    ListaComoFuncionanInd4: '<strong>Ongoing feedback and progress tracking 📈</strong> Shared repository (Google Classroom and Google Drive)',
    ListaComoFuncionanInd5: '<strong>Cancelations up to 24 hours in advance. The class will be rescheduled for another day at no extra cost</strong>',
    ...
    esteCursoEsParaTi: '⭐ This course is for you.',
    ...
    esUnPrograma: 'It’s a simple monthly subscription: pay month by month, with no commitment. Keep improving regularly and stay motivated with ease.',
    uneteALa:'Join the waiting list, fill out the form, and we\'ll notify you when your group opens.',
  ...
  SobreSpanish:{
    ...
    intro: '<strong>Behind every class, there’s a person, a story, and a way of teaching designed just for you. In a fast-paced world, learning can also be a refuge.</strong>',
    tulug: 'Your place',
    ...
    enmedio: 'In the middle of a world that never slows down, here you’ll find flexibility, quality, and a learning process that adapts to you and your goals. Our aim is to provide an accessible and effective learning environment, tailored to each student’s needs.',
    quien: 'Who is behind SpanishNook',
    soy: 'I\'m Paula, Spanish teacher, translator and interpreter.',
    tras: 'After more than four years teaching in schools, online, and privately across different European cities, I’ve had the chance to support students from very diverse backgrounds as they discover their own voice in Spanish. Over time, I realised that traditional classroom teaching has certain limitations today: sharing the same physical space isn’t essential for a meaningful learning experience. What truly matters is creating a safe and stimulating space where people can simply be and belong, connect, and grow without barriers. <br /><br /> From this idea, SpanishNook was born: a place where online teaching keeps the closeness and authenticity of a great class, with the added advantage of reaching any corner of the world and adapting better to your daily life-giving you the flexibility and control over your time that you need to learn.',
    ...
    cercania: '<strong>Closeness</strong>: human connection, small groups, relaxed atmosphere.',
    flexibilidad: '<strong>Flexibility</strong>: Spanish that adapts to your lifestyle.',
    confianza: '<strong>Confidence</strong>: real support at every step of your learning journey.',
    ojalá: '✦ I hope this little corner can become yours too.',
    espero: '<strong> I\'ll be waiting for you at SpanishNook to take the next step together.</strong>',
