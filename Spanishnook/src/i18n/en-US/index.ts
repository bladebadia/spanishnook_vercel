...
export default {
  ...
  NuestrasClases: {
    ...
    ListaComoFuncionanGrupos1: '<strong>1 class per week – 90 minutes<strong>',
    ListaComoFuncionanGrupos2: '<strong>Monthly subscription (€65): simple, flexible. Cancel anytime.<strong>',
    ListaComoFuncionanGrupos3: '<strong>Level-based groups</strong>',
    ListaComoFuncionanGrupos4: '<strong>Relaxed atmosphere</strong>, perfect for building confidence',
    ListaComoFuncionanGrupos5: '<strong>Maximum 6 students,</strong> so everyone truly participates',
    LogrosGrupales: '⭐ What will you achieve?',
    Logro1Grupales: 'Speak with more confidence and fluency',
    Logro2Grupales: 'Expand useful everyday vocabulary',
    Logro3Grupales: 'Express ideas, opinions and experiences naturally',
    Logro4Grupales: 'Improve pronunciation and listening comprehension',
    Logro5Grupales: 'Join real conversations with ease',
    Logro6Grupales: 'See your progress without even noticing',
    ...
    ListaComoFuncionanInd1: 'Live online sessions of 60 minutes 🕒 with 100% personalized materials',
    ListaComoFuncionanInd2: 'Flexible scheduling 🗓️: book your classes on the calendar whenever you want.',
    ListaComoFuncionanInd3: 'Choose your focus: conversation or general Spanish 🎯',
    ListaComoFuncionanInd4: 'Feedback and continuous monitoring 📈 and shared repository (Google Classroom and Google Drive)',
    ListaComoFuncionanInd5: 'Cancellations: You can cancel up to 24 hours in advance. The class will be rescheduled for another day at no extra cost.',
    ...
    cadaSemanaNos: 'Every week we meet in small groups (max. 6 students) to practise Spanish in a real, practical and enjoyable way. We work with current topics and activities designed to help you speak more, feel relaxed and gain confidence from day one.',
