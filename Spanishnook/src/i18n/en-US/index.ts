...
export default {
  ...
  indexDetrasDeSpanishnook: 'At SpanishNook, we believe that learning a language should be a personal, flexible, and positive experience. That’s why we’ve created this online space: a place designed to support you on your journey with live, personalised classes. The project was born from the experience and passion of Paula, a Spanish teacher with several years of teaching experience. Today, SpanishNook is a place where you can feel comfortable while learning, with carefully curated materials and ongoing support.',
  ...
  test:{
        ...
        alCompletar: 'At the end, you will receive an approximate indication of your Spanish level. <strong>This test does not replace an official evaluation, but it will help you choose the course that best suits you.</strong>',
  ...
  NuestrasClases: {
    ...
    textoNuestrasClases: 'At SpanishNook, there isn’t just one path: every student has their own goals, schedule, and way of learning. <br> That’s why we offer flexible options, so you can choose what fits you best: private classes or small group courses.',
    ...
    IntroNuestrosCursosGrupo: 'Do you understand Spanish but struggle to speak it naturally? <br> Do you want to feel more confident speaking Spanish without being afraid of making mistakes?',
    ...
    IntroIndividuales: 'Learn at your own pace with classes designed just for you and your learning needs. Choose whether you want to improve your speaking fluency or work on other aspects of the language. You choose the path, the topics, and the goals. We provide the support and resources.',
    Modalidades: 'Class Formats',
    Modalidad1: '1:1 Conversational Classes',
    ...
    Modalidad2: '1:1 General Spanish Classes',
    ...
    ListaComoFuncionanInd5: '<strong>Cancellations up to 24 hours in advance. The class will be rescheduled for another day at no extra cost</strong>',
  ...
  SobreSpanish:{
    ...
    cercania: '<strong>Closeness</strong>: human connection, small groups and a relaxed atmosphere.',
    ...
    espero: '<strong> I\'ll be waiting for you at SpanishNook so we can take the next step together.</strong>',
