...
export default {
  ...
  NuestrasClases: {
    ...
    IntroIndividuales: '<strong>Learn at your own pace with classes designed just for you and your learning needs.</strong> <br><br> Choose whether you want to improve your speaking fluency or work on other general aspects of the language. You choose the pace, the topics, and the goals. We provide the support and resources.',
